...
The corpus is the 291 canonical pages of this repository. Retrieval selects at most 8 concepts within a 14000-character budget, using exact names, aliases and full text. There are no embeddings, and this evaluation exists to decide whether there is evidence for adding any.
...
- Retrieved instead: `concept.deep_learning.radial_basis_function_networks`, `concept.analysis.vector_calculus`, `concept.deep_learning.gru`, `concept.geometry.renormalization`, `concept.learning.meta_learning`
...
- Needed but not retrieved: `concept.deep_learning.residual_connection`
- Retrieved instead: `concept.deep_learning.boltzmann_machines`, `concept.ml_engineering.ollama`, `concept.machine_learning.decision_trees`, `concept.ml_engineering.pytorch`, `concept.systems.operating_systems`
...
- Retrieved instead: `concept.deep_learning.vgg`, `concept.deep_learning.convolutional_networks`, `concept.vision.classification`, `concept.deep_learning.resnet`, `concept.deep_learning.flow_matching`
...
- Retrieved instead: `concept.deep_learning.convolutional_layer`, `concept.deep_learning.vision_transformer`, `concept.deep_learning.convolutional_networks`, `concept.analysis.translation_equivariance`, `concept.deep_learning.geometric_deep_learning`
...
| P1 | paraphrase | Why does sliding a filter over an image work the same wherever the object is? | `analysis.translation_equivariance` | no |
